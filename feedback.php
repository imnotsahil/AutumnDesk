...
<title>AutumnDesk|| FEEDBACK </title>
...
<div class="col-lg-6">
<span class="logo">AutumnDesk</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-10">
<a href="mailto:imnotsahil@gmail.com" style="color:#000000">imnotsahil@gmail.com</a><br /><br />
...
<a href="aboutus.txt" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
...
<div class="modal fade title1" id="developers">
  <div class="modal-dialog">
    ...
    <div class="row">
    <div class="col-md-4">
     <img src="image/CAM00121.jpg" width=100 height=100 alt="sahil&sweety" class="img-rounded">
     </div>
     <div class="col-md-5">
    <a href="https://instagram.com/eliot_5515?utm_source=ig_profile_share&igshid=1fhcay72z1yhd" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">sahil&sweety</a>
    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9663392076</h4>
    <h4 style="font-family:'typo' ">imnotsahil@gmail.com</h4>
    <h4 style="font-family:'typo' ">sri venkateshwara college of engineering ,vidyanagar cross ,bangalore</h4></div></div>
    </p>
      </div>
