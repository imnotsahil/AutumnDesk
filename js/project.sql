...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `user` ()  SELECT * FROM user$$
...
(3, 'sweety@gmail.com', 'sahil123');

--
-- Triggers `admin`
--
DELIMITER $$
CREATE TRIGGER `insert_logs` AFTER INSERT ON `admin` FOR EACH ROW INSERT INTO logs VALUES(NULL,new.admin_id,'inserted',NOW())
$$
DELIMITER ;
...
('rakesh@gmail.com', '5589741f9ed52', -5, 5, 0, 5, '2018-12-07 10:23:32');
...
INSERT INTO `logs` (`id`, `admin_id`, `action`, `c_date`) VALUES
(1, 3, 'inserted', '2018-12-07 10:45:59');
...
('rakesh@gmail.com', -5, '2018-12-07 10:23:32');
...
('Sahil', 'M', 'svce', 'imnotsahil@gmail.com', 9663392076, '2aa0c1017f8087216c114b1a218d0a2b'),
('Sweety Sahil', 'F', 'svce', 'imnotsweety@gmail.com', 9663392076, '2aa0c1017f8087216c114b1a218d0a2b'),
...
('Rakesh', 'M', 'SVCE', 'rakesh@gmail.com', 9663392076, 'e10adc3949ba59abbe56e057f20f883e'),
...
--
DELIMITER $$
CREATE TRIGGER `ins_usr_logs` AFTER INSERT ON `user` FOR EACH ROW INSERT into userlogs VALUES(NULL,new.name,new.email,'inserted',NOW())
$$
DELIMITER ;
...
INSERT INTO `userlogs` (`id`, `name`, `email`, `action`, `created`) VALUES
(1, 'sweetyS', 'imnotsweety@gmail.com', 'inserted', '2018-12-07 10:47:10'),
(2, 'Sahil', 'imnotsahil@gmail.com', 'inserted', '2018-12-07 10:49:05'),
(3, 'Sweety Sahil', 'imnotsweety@gmail.com', 'inserted', '2018-12-07 10:52:06'),
(4, 'Rakesh', 'rakesh@gmail.com', 'inserted', '2018-12-07 15:52:53');
